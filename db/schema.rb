...
ActiveRecord::Schema[8.0].define(version: 2025_03_01_105647) do
  ...
  create_table "routines", force: :cascade do |t|
    ...
    t.integer "exercise_sets_id", null: false
  ...
  add_foreign_key "routines", "exercises", column: "exercises_id"
